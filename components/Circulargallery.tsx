...
class Media {
  ...
  onResize({ screen, viewport }: { screen?: ScreenSize; viewport?: Viewport } = {}) {
    ...
    // ── Larger images: was 900×700, now 1300×1000 ──
...
class App {
  ...
  constructor(container: HTMLElement, { items, bend = 1, borderRadius = 0, scrollSpeed = 2, scrollEase = 0.05 }: AppConfig) {
  ...
  createMedias(items: { image: string; text: string }[] | undefined, bend: number, borderRadius: number) {
    const defaultItems = [
      ...
      { image: `https://picsum.photos/seed/4/800/600`, text: '' },
      { image: `https://picsum.photos/seed/5/800/600`, text: '' },
      { image: `https://picsum.photos/seed/16/800/600`, text: '' },
      { image: `https://picsum.photos/seed/17/800/600`, text: '' },
      { image: `https://picsum.photos/seed/8/800/600`, text: '' },
    ];
